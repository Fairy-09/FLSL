...
path = r"../../Dataset/house5_5min_KWh.csv"
...
data_test.to_csv(r"./myresult/test5.csv", index=False, header=False)
data_pre = pd.DataFrame(pred_testY_origin)
data_pre.to_csv(r"./myresult/pre5.csv", index=False, header=False)
